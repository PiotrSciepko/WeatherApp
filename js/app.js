const showWeatherBox = (box, location = "Warszawa") => {
    ...
    fetch(`http://api.weatherapi.com/v1/forecast.json?key=f8e7ba3672fd4af1b7d125524212803&q=${location}&days=3`)
        .then(el => el.json())
        .then(data => {
